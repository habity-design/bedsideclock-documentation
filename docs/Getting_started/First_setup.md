...
[![travel-lock-1.png](https://github.com/ptrarvad/habity-bedsideclock-docs/raw/main/docs/Assets/travel-lock-1.png)](/ptrarvad/habity-bedsideclock-docs/blob/main/docs/Assets/travel-lock-1.png)
...
**Step 1** Enter the menu by pressing the selector wheel.

**Step 2** Go to "More" > "Date & time". Use the selector wheel to navigate and enter settings.
...
> [!NOTE]
> Automatic date & time requires a [Wi-Fi connection](https://github.com/ptrarvad/habity-bedsideclock-docs/blob/main/Connectivity/Connect_to_Wi-Fi). You must connect your bedside clock to Wi-Fi to use this feature.
