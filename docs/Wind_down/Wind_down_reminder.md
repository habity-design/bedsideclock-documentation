...
The wind down reminder will display a message on your clock at the set time for you to wind down. You can either play a soundscape or dismiss the message. [![wind-down.png](https://github.com/habity/bedsideclock-ducomentation/raw/main/docs/Assets/wind-down.png)](/habity/bedsideclock-documentation/blob/main/docs/Assets/wind-down.png)
...
> [!NOTE]
> **Repeats daily** All wind down reminders repeat on a daily basis to support a consistent bedtime routine.