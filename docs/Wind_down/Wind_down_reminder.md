...
The wind down reminder will display a message on your clock at the set time for you to wind down. You can either play a soundscape or dismiss the message. [![wind-down.png](https://github.com/ptrarvad/habity-bedsideclock-docs/raw/main/docs/Assets/wind-down.png)](/ptrarvad/habity-bedsideclock-docs/blob/main/docs/Assets/wind-down.png)
