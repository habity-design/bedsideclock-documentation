...
**Recovery mode is used in troubleshooting cases where the clock is functioning abnormally. Examples could be no sound playing, nothing showing on the display, or a display that is faded or not clear.**

It takes 24 hours or less to complete the recovery. You can stop and restart the process at any time.
You know the recovery process is done when the e-paper display goes blank and the light turns off.

# How To
1. Disable your alarms and wind-down reminder so they don't interrupt the process.
